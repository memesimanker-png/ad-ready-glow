          ...
          <article className="flex-1 min-w-0">
            <header className="mb-6">
              <div className="flex items-start gap-4 mb-4">
                <GameThumbnail gameName={script.game} universeId={(script as any).game_universe_id} gameUrl={(script as any).game_url} customUrl={(script as any).thumbnail_url} size="lg" />
                    ...
                    {related.map((s) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          <GameThumbnail gameName={s.game} universeId={(s as any).game_universe_id} gameUrl={(s as any).game_url} customUrl={(s as any).thumbnail_url} size="sm" />
