        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              { title: "2. Description of Services", content: "ComboWick provides a digital marketplace for purchasing verified Roblox accounts and premium game keys. All products are digital in nature and delivered electronically through our secure dashboard. We offer various account packages at different price points, and all products are subject to availability. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time." },
              ...
              { title: "4. Digital Products and Delivery", content: "All products sold on ComboWick are digital access credentials (Roblox account login details and premium keys). Products are delivered instantly upon successful payment confirmation through our automated delivery system. Once delivered, account credentials are accessible through your ComboWick dashboard. You are responsible for securely storing your credentials and changing passwords promptly after receiving accounts." },
              ...
              { title: "6. Refund Policy", content: "Due to the instant digital nature of our products, all sales are generally final. Refunds are not provided once account credentials or keys have been delivered and accessed. In cases where a product does not function as described, contact our support team within 24 hours for a replacement or resolution. For full details, please review our dedicated Refund Policy page." },
              { title: "7. User Conduct", content: "When using ComboWick, you agree not to: (a) attempt to reverse engineer, decompile, or hack any part of our platform; (b) share, redistribute, or resell purchased account credentials to third parties; (c) use our services for any illegal or unauthorized purpose; (d) impersonate another person or entity; (e) interfere with or disrupt the integrity of our platform; (f) use automated systems (bots, scrapers) to access our services without permission. Violation of these terms may result in immediate account termination and forfeiture of purchased products." },
