...
import { Shield, Monitor, Smartphone, Apple, ExternalLink, MessageCircle, ShoppingCart, RefreshCw, AlertCircle, CheckCircle2, Search, X, Cpu, Boxes, KeyRound, Code2, Layers } from "lucide-react";
