  ...
  return (
    <article className="group relative flex flex-col rounded-lg border border-border bg-card hover:border-primary/50 transition-all duration-200 overflow-hidden">
      <div className="flex items-center gap-3 px-4 pt-4 pb-2">
        <GameThumbnail gameName={script.game} universeId={(script as any).game_universe_id} gameUrl={(script as any).game_url} customUrl={(script as any).thumbnail_url} size="sm" />
